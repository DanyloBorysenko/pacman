...
#     """Iterates through all active ghosts to verify
#     if they collide with Pac-Man."""
...
#         if distance < 0.5:
#             # Handle cheat mode: if invincibility is active,
#             # skip punishing the player
...
#                 # Add a cooldown timer for respawning
#                 # if required by your layout rules
#             else:
